...
<html>
  <head>
    ...
    <title>Admon. de Películas</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>Admón. de Peliculass</b><</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Admón. de Peliculas</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['almacen']==1)
            {
              ...
              <ul class="treeview-menu">
                <li id="lArticulos"><a href="articulo.php"><i class="fa fa-circle-o"></i> Películas</a></li>
